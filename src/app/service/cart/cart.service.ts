...
export class CartService {
  ...
  postsparePart(name:any,part_no:any,warranty_info:any,file:any,remark:any,chassis:any,model:any,color:any,c_name:any,sale_date:any,warranty:any):Observable<any>{
    const formData = new FormData();
